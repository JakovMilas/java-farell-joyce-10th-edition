...
public class Quiz {
	...
	public static void main(String[] args) {
		...
		correctAnswers += resolveAnswer(1, answer, q1a3);

		answer = displayQuestion(q2, q2a1, q2a2, q2a3, q2a4);
		correctAnswers += resolveAnswer(2, answer, q2a4);

		answer = displayQuestion(q3, q3a1, q3a2, q3a3, q3a4);
		correctAnswers += resolveAnswer(3, answer, q3a1);

		answer = displayQuestion(q4, q4a1, q4a2, q4a3, q4a4);
		correctAnswers += resolveAnswer(4, answer, q4a1);

		answer = displayQuestion(q5, q5a1, q5a2, q5a3, q5a4);
		correctAnswers += resolveAnswer(5, answer, q5a3);

		percent = ((double) correctAnswers / 5) * 100.0;
	...
	public static int resolveAnswer(int q, int a, String c) {
		if (q == 1 && a == 2) {
			...
			System.out.println("Incorrect, answer is " + c);
		return 0;
	}
}
